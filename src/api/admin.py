...
from .models import db, User, Role, User_role, Pro_profile, Skill, Pro_profile_skill, Cmr_profile, Home, Home_Post, Post_skills, Contract, Cmr_review, Pro_review, Message, Message_receiver
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(Home_Post, db.session))
