			...
			<div className="max-w-screen-xl px-4 mx-auto">
										...
										<div className="mt-8">
											...
											<form action="#" autoComplete="off">
												...
												<div className="flex w-full">
													<button
														type="submit"
														className="py-2 px-4  bg-indigo-500 hover:bg-indigo-500 focus:ring-indigo-500 focus:ring-offset-indigo-500 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg "
													>
														Login
													</button>
												</div>
				...
				<div className="newsletter text-center pt-10 sm:pt-12 font-light flex items-center justify-center">
					<form className="flex flex-col justify-center w-3/4 max-w-sm space-y-3 md:flex-row md:w-full md:space-x-3 md:space-y-0">
						<div className=" relative ">
							<input type="text" id="&quot;form-subscribe-Subscribe" className=" rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" placeholder="Email" />
						</div>
						<button className="flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-indigo-500 rounded-lg shadow-md hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-indigo-200" type="submit">
							Suscribete
						</button>
					</form>
				</div>
				...
				<div className="iconos-pago text-center pt-10 sm:pt-12 font-light flex items-center justify-center">
					...
					<div className="flex items-center justify-between mb-6 rounded">
						<span className="rounded-lg">
							<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" className="rounded" viewBox="0 0 192.756 192.756">
						...
						<span className="rounded-lg">
							<svg width="40" height="40" className="rounded" viewBox="-.09581478 0 123.74964463 30.22562129" xmlns="http://www.w3.org/2000/svg">
