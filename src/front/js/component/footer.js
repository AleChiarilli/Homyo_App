				...
				<div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
					<div>
						...
						<ul className="text-gray-600 dark:text-gray-400 font-medium">
							<li className="mb-4">
								<a href="https://flowbite.com/" className="hover:underline">Contáctanos</a>
							</li>
							<li>
								<a href="https://tailwindcss.com/" className="hover:underline">Preguntas frecuentes</a>
							</li>
						</ul>
					</div>
					<div>
						...
						<ul className="text-gray-600 dark:text-gray-400 font-medium">
							<li className="mb-4">
								<a href="https://github.com/themesberg/flowbite" className="hover:underline ">Términos y condiciones</a>
							</li>
							<li className="mb-4">
								<a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Política de privacidad</a>
							</li>
							<li className="mb-4">
								<a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Política de cookies</a>
							</li>
							<li className="mb-4">
								<a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Política de cancelación</a>
							</li>
							<li>
								<a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Aviso legal</a>
							</li>
						</ul>
					</div>
