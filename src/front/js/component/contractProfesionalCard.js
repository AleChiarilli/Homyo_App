...
export const Contractprofesionaldcard = () => {
    ...
    return (
        <div className="w-full flex flex-col justify-center mt-10 mb-3">
            <div className="relative flex flex-col md:flex-row md:space-x-5 space-y-3 md:space-y-0 rounded-xl shadow-lg p-3 max-w-xs md:max-w-3xl mx-auto border border-white bg-white">
                ...
                <div className="w-full md:w-2/3 bg-white flex flex-col space-y-2 p-3">
                    ...
                    <div>
                    <textarea rows="3" className="p-4 text-gray-500 rounded-xl resize-none">Mensaje del cliente detallando el servicio</textarea>
                    </div>
