...
export const Contractofferprofesionaltoclientcard = () => {
    ...
    return (
        <div className="p-3 flex flex-col justify-center mt-10 mb-3 dark:bg-gray-800">
        <div className="relative flex flex-row md:space-x-5 space-y-3 md:space-y-0 rounded-xl shadow-lg p-3 bg-white dark:bg-gray-700 mx-auto border border-white">
          <div className=" md:w-1/4 bg-white dark:bg-gray-700 grid place-items-center">
            <img src={avatar} className="rounded-full" alt="Avatar" />
          </div>
          <div className=" md:w-2/3 bg-white dark:bg-gray-700 flex flex-col space-y-2 p-3">
