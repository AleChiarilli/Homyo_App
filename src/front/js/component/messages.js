...
export const Messages = () => {
    return (
        ...
        <div className="flex p-4 mt-10 h-screen antialiased text-gray-800 max-w-screen-xl mx-auto">
            <div className="flex flex-row h-full w-full overflow-x-hidden">
                <div className="flex flex-col py-8 pl-6 pr-4 w-64 bg-white flex-shrink-0 rounded-lg">
                    <div className="ml-2 font-bold text-2xl text-center">HOMYO Chat</div>
